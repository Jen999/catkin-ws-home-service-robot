...
echo_and_run cd "/home/tanlingjen/catkin-ws-home-service-robot/src/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/tanlingjen/catkin-ws-home-service-robot/src/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/home/tanlingjen/catkin-ws-home-service-robot/build/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
